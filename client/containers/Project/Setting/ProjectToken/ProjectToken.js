      ...
      <div className="project-token">
        ...
        <div>
          <ul className="open-api">
            ...
            <li>/api/interface/tree [获取接口树分页]</li>
            <li>/api/interface/tree/node [按分类获取接口节点]</li>
            <li>/api/interface/add_cat [新增接口分类]</li>
            <li>/api/interface/getCatMenu [获取所有分类]</li>
            <li>/api/spec/import [OpenAPI/Swagger 规范导入]</li>
            <li>/api/spec/import/task [获取导入任务详情]</li>
            <li>/api/spec/import/tasks [获取导入任务列表]</li>
            <li>/api/spec/import/task/download [下载导入任务结果]</li>
            <li>/api/spec/export [OpenAPI/Swagger 规范导出]</li>
            <li>/api/spec/metrics [导入导出性能指标快照(管理员)]</li>
          </ul>
        </div>
      </div>
    );
