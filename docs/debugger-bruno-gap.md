...
| Import/export | Bruno, Postman, OpenAPI, Insomnia, WSDL, OpenCollection, env | Partial | Existing OpenAPI/Postman/HAR remain. Bruno single `.bru` HTTP request import now maps method/url/query/path params/headers/body/auth/scripts/tests/docs into the local workspace model. Multi-file Bruno collection import/export and Insomnia/WSDL/OpenCollection are pending. |
