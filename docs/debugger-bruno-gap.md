...
| Import/export | Bruno, Postman, OpenAPI, Insomnia, WSDL, OpenCollection, env | Partial | Existing OpenAPI/Postman/HAR remain. Bruno single `.bru` HTTP request import/export now maps method/url/query/path params/headers/body/auth/scripts/tests/docs across the local workspace model, with a response toolbar copy entry for the active request. Multi-file Bruno collection import/export and Insomnia/WSDL/OpenCollection are pending. |
