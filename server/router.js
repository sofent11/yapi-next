...
const internalInterfaceController = require('./controllers/internalInterface.js');
const specController = require('./controllers/spec.js');
...
let INTERFACE_CONFIG = {
  ...
  internal: {
    prefix: '/internal/interface/',
    controller: internalInterfaceController
  },
  spec: {
    prefix: '/spec/',
