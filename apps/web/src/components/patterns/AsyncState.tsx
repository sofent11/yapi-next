...
export function AsyncState(props: AsyncStateProps) {
  ...
  return (
    <div className="rounded-[var(--radius-xl)] border border-[var(--border-subtle)] bg-[var(--surface-panel)] px-6 py-12 text-center text-[var(--text-primary)] shadow-[var(--shadow-panel)] dark:!border-[var(--border-project-subtle)] dark:!bg-[var(--surface-project-panel)]">
